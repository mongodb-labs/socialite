...
benchmark="timeline-read-follower-ramp"
...
for scenario in $@ ; do 
    ...
    java -jar ./target/socialite-0.0.1-SNAPSHOT.jar $benchmark --out $scenario_outdir $scenario
...
set xtic auto
set ytic auto
set title "Timeline read latency by follower count"
set xlabel "# of friends"
